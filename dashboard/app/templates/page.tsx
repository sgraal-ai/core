          ...
          <div key={t.id} style={{ ...CARD, position: "relative" }}>
            ...
            <div style={{ padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div style={{ flex: 1 }}>
                ...
                <pre style={{ background: "#f8f8f8", borderRadius: "6px", padding: "12px 14px", fontSize: "13px", fontFamily: "monospace", color: "#4b5563", lineHeight: 1.6, overflowY: "auto", overflowX: "auto", whiteSpace: "pre", maxHeight: "140px", marginTop: "8px" }}>
                  {t.code}
                </pre>
              </div>
