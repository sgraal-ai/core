...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#faf9f6]/90 backdrop-blur-md shadow-[0_12px_40px_rgba(11,15,20,0.04)]">
      <div className="max-w-7xl mx-auto h-20 px-8 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            {pillars.map((p) => (
              <a key={p.label} href={p.href}
                className={`text-sm font-medium transition-colors ${path.startsWith(p.href) ? "text-primary-container" : "text-[#6b6b6b] hover:text-[#1a1c1a]"}`}>
                {p.label}
              </a>
            ))}
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/sgraal-ai" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-on-surface transition-colors">
          ...
          <a href="https://x.com/sgraal_ai" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-on-surface transition-colors">
