  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden px-8 md:px-16 py-16 lg:py-24 flex flex-col items-center text-center max-w-[1440px] mx-auto">
        ...
        <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tighter text-on-background max-w-5xl leading-[1.05] mb-8 text-balance">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
            ...
            {[
              ...
              <div key={s.n} className="space-y-6">
                <div className="w-14 h-14 rounded-full border-2 border-primary-container bg-background flex items-center justify-center text-2xl font-bold text-primary shrink-0 shadow-sm shadow-primary-container/20">{s.n}</div>
      ...
      <section className="bg-surface-container-low px-8 md:px-16 py-24 text-center">
        <div className="max-w-7xl mx-auto">
          <span className="text-[10px] font-bold tracking-[0.3em] text-secondary/50 block mb-12">WORKS WITH</span>
          <div className="flex flex-wrap justify-center gap-4">
            {badges.map((b) => (
              <span key={b} className="px-6 py-2.5 bg-surface-container-lowest border border-outline-variant/10 rounded-full text-sm font-medium text-on-surface-variant hover:border-primary-container transition-colors">{b}</span>
            ))}
          </div>
        </div>
      </section>
