  ...
  return (
    <html lang="en" className="h-full antialiased">
      <body className="min-h-full flex flex-col bg-background text-on-surface font-body">
        <nav className="sticky top-0 z-40 bg-[#faf9f6]/90 backdrop-blur-md shadow-[0_12px_40px_rgba(11,15,20,0.04)]">
          <div className="max-w-7xl mx-auto h-20 px-8 flex items-center justify-between">
            <div className="flex items-center gap-10">
              <a href="/" className="text-2xl font-bold tracking-tighter text-[#1a1c1a] font-headline">Sgraal</a>
              <div className="hidden md:flex items-center gap-6">
                <a href="/decide" className="text-sm font-medium text-[#6b6b6b] hover:text-[#1a1c1a] transition-colors">DECIDE</a>
                <a href="/protect" className="text-sm font-medium text-[#6b6b6b] hover:text-[#1a1c1a] transition-colors">PROTECT</a>
                <a href="/comply" className="text-sm font-medium text-[#6b6b6b] hover:text-[#1a1c1a] transition-colors">COMPLY</a>
                <a href="/scale" className="text-sm font-medium text-[#6b6b6b] hover:text-[#1a1c1a] transition-colors">SCALE</a>
                <a href="/#pricing" className="text-sm font-medium text-[#6b6b6b] hover:text-[#1a1c1a] transition-colors">Pricing</a>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <a href="https://github.com/sgraal-ai" target="_blank" rel="noopener noreferrer" className="text-[#6b6b6b] hover:text-[#1a1c1a] transition-colors">
